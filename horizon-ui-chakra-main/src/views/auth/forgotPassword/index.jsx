...
export default function ForgotPassword() {
  ...
  const successBoxBg = useColorModeValue("white", "navy.800");
  const successBorderColor = useColorModeValue("gray.200", "whiteAlpha.200");
  const backgroundBg = useColorModeValue("gray.50", "gray.900");
